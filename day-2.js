...
function day2Part2() {
  ...
  // 1. Ask the user for data
  bank = prompt("How much is in you bank account?");
...
function day2Part4() {
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The rocket costs ${rocketNumber}. You have ${bankNumber} in your bank acount. You can afford the rocket: ${bankNumber >= rocketNumber}.`;
